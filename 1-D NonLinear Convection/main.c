...
int main(){
  ...
  int x_points = 10001;    // Number of points to consider
...
//  }
  ...
  int t_itrs = 5000;  // number of time iterations
  double del_t = 0.001;
...
//  }
  ...
  printf("\n Speed up obtained is: %f \t", (ser_end_time-ser_start_time)/(par_end_time-par_start_time));
